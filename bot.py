...
client = OpenAI(
  api_key="AIzaSyAkIprSgyPwTjSKxTpGTGUm0u4K2x4w-N8",
)

def is_last_message_from_sender(chat_log, sender_name="Abdul Khadar"):
...
while True:
    ...
    if is_last_message_from_sender(chat_history):
        ...
        messages=[
            ...
            {"role": "system", "content": "Do not start like this [21:02, 12/6/2024] Andul khadar: "},
